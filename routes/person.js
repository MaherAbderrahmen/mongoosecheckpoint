...
// test route
// @ route : localhost:5000/persons/test
...
router.get("/all", (req, res) => {
  ...
  var arrayOfPeople = [
    { name: "Maher", age: 37, favoriteFoods: ["pizza"] },
    { name: "Ahmed", age: 27, favoriteFoods: ["makloub"] },
    { name: "Hamouda", age: 49, favoriteFoods: ["salade"] },
  ];
...
router.get("/person/food/:food", (req, res, next) => {
  ...
  router.get("/person/:id/:addFood", function (req, res) {
